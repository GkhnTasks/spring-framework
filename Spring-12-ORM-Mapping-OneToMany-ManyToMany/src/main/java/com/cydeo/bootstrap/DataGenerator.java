...
public class DataGenerator  implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Customer customer1= new Customer("msmith","Mike","Smith", "smith@cydeo.com","VA");
        ...
        Item item1= new Item("Milk","MO1");
        Item item2= new Item("Sugar","SO1");
        Item item3= new Item("Bread","BO1");
